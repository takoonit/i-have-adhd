...
9가지 규칙. 전문은 [SKILL.md](../../skills/i-have-adhd/SKILL.md)에 있습니다.

1. 다음 행동부터 말하기, 2분 안에 시작할 수 있게.
2. 다단계 작업은 번호로.
3. 한 가지 구체적인 다음 단계로 끝내기.
4. 엉뚱한 이야기 자르기.
5. 매 턴마다 상태 다시 알리고, 지금 무엇이 되는지 보여 주고, 대화보다 오래 남는 기록 남기기.
6. 단계마다 정확한 시간 (분 단위, "조금" ❌, 시각 ❌).
7. 오류는 담백하게. 상태를 말하고, 탓하지 않기.
8. 목록은 자르지 말고 순서를 매기기. 선택지는 3개까지.
9. 서론, 요약, 마무리 인사 없음.
