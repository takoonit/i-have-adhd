...
4. Duration is hard to judge and harder to hold. A vague estimate gives the reader nothing to bound the work with. A concrete one does, even when it is only roughly right.
